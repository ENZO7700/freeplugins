  ...
  const handleListen = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Nepodarilo sa vygenerovať zvukovú verziu článku. Skúste to znova.",
      });
    } finally {
          ...
          <article>
            ...
            <Card className="my-8 p-6 bg-secondary/30 flex flex-col sm:flex-row items-center justify-between gap-4">
              <div>
                ...
                <p className="text-muted-foreground">Kliknite na tlačidlo a nechajte si článok prečítať.</p>
              </div>
              <Button onClick={handleListen} disabled={isGeneratingAudio || !!audioUrl}>
                {isGeneratingAudio ? (
                  <>
